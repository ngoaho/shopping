...
add_filter('gettext', 'change_cart_summary_text', 20, 3);
function change_cart_summary_text($translated_text, $text, $domain) {
    if (trim($text) === 'Cart Summary') {
        $translated_text = 'Tóm tắt giỏ hàng';
    }
